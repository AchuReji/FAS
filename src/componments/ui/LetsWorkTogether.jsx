...
export function LetsWorkTogether() {
  ...
  const handleBookCall = () => {
    window.open("https://cal.com/achu-reji-bhozmr", "_blank")
  }

  return (
    <section className="flex min-h-screen items-center justify-center px-6 bg-[#D4D6CC]">
      <div className="relative flex flex-col items-center gap-12">
        ...
        >
          ...
          <span className="text-xs tracking-widest uppercase text-muted-foreground/60">hello@fasksa.com</span>
        </div>
      </div>
    </section>
  )
