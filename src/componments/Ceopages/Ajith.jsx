        ...
        <div className="relative z-10 max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="relative group">
            ...
            <div className="relative w-48 h-48 md:w-64 md:h-64 rounded-full border-4 border-white overflow-hidden shadow-2xl">
              <img 
                src="https://image2url.com/r2/default/images/1773137730588-65ff7d4c-eb13-45d3-917b-933f69e9a079.jpeg" 
                alt="CA Ajith Sam"
          ...
          <div className="text-center md:text-left">
            <h1 className="text-5xl md:text-7xl font-bold mb-4 tracking-tight">CA Ajith Sam</h1>
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4">
              ...
              <span className="bg-white/10 backdrop-blur-md px-6 py-2 rounded-full text-sm font-bold border border-white/20 shadow-xl">B.com</span>
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-stretch">
            <div className="lg:w-2/3 bg-white p-10 rounded-3xl shadow-2xl border border-slate-100">
              ...
              <p className="text-lg leading-relaxed text-slate-700 mb-6">
                A result-oriented, self-motivated, and resourceful Chartered Accountant with a proven ability to develop and strengthen management teams to maximize company profitability and efficiency.
              </p>
